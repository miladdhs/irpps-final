...
class CustomUser(AbstractUser):
    """Extended user model with profile and resume fields."""
    ...
    workplace = models.CharField(max_length=200, blank=True, null=True, verbose_name='محل کار')
    current_position = models.CharField(max_length=200, blank=True, null=True, verbose_name='سمت فعلی')
    expertise_areas = models.TextField(blank=True, null=True, verbose_name='حوزه‌های تخصص')
    work_experience = models.TextField(blank=True, null=True, verbose_name='سوابق کاری')
