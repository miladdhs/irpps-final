...
class Event(models.Model):
    ...
    registration_date = models.DateField(blank=True, null=True, verbose_name='تاریخ ثبت نام')
    ...
    class Meta:
        ...
        ordering = ['-event_date', '-event_year', '-event_month', '-created_at']
    ...
    def effective_registration_deadline(self):
        return self.registration_date or self.registration_deadline

    @property
    def is_registration_open(self):
        deadline = self.effective_registration_deadline
        if deadline:
