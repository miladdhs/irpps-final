      ...
      <div class="container-xl">
        <div class="row align-items-center">
          <div class="col-md-12 text-center">
            ...
            <h1 class="display-4 fw-bold mb-4">{{ $t('nav.boardThird') }}</h1>
            <p class="lead text-muted">{{ $t('about.boardMembers1403Title') }}</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row g-4">
          <div class="col-md-12">
            <div class="board-members-card glass-card p-5">
              <h3 class="fw-bold mb-4 text-center">هیئت مدیره دوره ۱۴۰۳ (پس از انتخابات الکترونیکی)</h3>
              <div class="row g-4">
