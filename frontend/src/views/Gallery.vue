<template>
  <div class="page-shell gallery-view position-relative overflow-x-hidden">
        ...
        <div class="row g-4">
          <div class="col-md-12">
            <div class="glass-card p-5">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  <div class="gallery-item glass-card p-3 text-center">
                    <i class="fa fa-image fa-4x text-primary mb-3"></i>
                    <p class="mb-0">همایش‌ها و کنگره‌ها</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="gallery-item glass-card p-3 text-center">
                    <i class="fa fa-image fa-4x text-primary mb-3"></i>
                    <p class="mb-0">کارگاه‌های آموزشی</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="gallery-item glass-card p-3 text-center">
                    <i class="fa fa-image fa-4x text-primary mb-3"></i>
                    <p class="mb-0">فعالیت‌های علمی</p>
                  </div>
                </div>
              </div>
            </div>
